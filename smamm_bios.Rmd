...
ggtree(pruned_grouped, aes(color = group),
  ...
  xlim(-10,400) +
  annotate('text', x = -10, y = 20, hjust = 0,
           label = 'Small mammals are in black. Larger mammals that \nwere seen at our sites but not included in these analyses are included in grey.')
