...
Tab 1: sites for each severity highlighted
Tab 2: sites for each species highlighted
...
# CAN USE ELEMENTS ASSOCIATED WITH SELCTIONS FROM GGIRAPH AS INPUT IN SHINY APP
